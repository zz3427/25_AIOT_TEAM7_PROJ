...
def analyze_parking_image(image_path: str) -> Dict[str, Any]:
    ...
    system_prompt = (
        ...
        "In the upper part of the image there is a single row of parking spaces, separated by vertical black lines, "
        ...
        "Define parking spaces as contiguous rectangular regions between two vertical divider lines, or between a divider "
        "line and the image edge. Each such region counts as exactly one parking spot, even if there is no car there. "
    ...
    user_text_prompt = (
        ...
        "    ... one entry for each spot, in order from left to right ...\n"
        "  ]\n"
        "}\n\n"
        "Rules:\n"
        "- \"spot_index\" must form a contiguous sequence from 0 to total_spots-1, with no gaps.\n"
